...
var rootCmd = &cobra.Command{
	Use:   "fairyport",
	Short: "Fairyport is a tool for fetching aggregated key from fairyring to destination chain.",
	Long:  `Fairyport is a tool for fetching aggregated key from fairyring to destination chain.`,
}
